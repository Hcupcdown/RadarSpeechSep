...
def get_config():
    ...
    parser.add_argument('--model', type=str, default='DPRNN', help='DPRNN, ConvTasNet, MossFormer, RadioSES, RadarMossFormer')
    # dataset
    parser.add_argument('--train', type=str, default=r'D:\Backup\桌面\当前工作\0_data_process\my_radar_sound\data\unseen\2mix\train', help='Train path')
    parser.add_argument('--val', type=str, default=r'D:\Backup\桌面\当前工作\0_data_process\my_radar_sound\data\unseen\2mix\test', help='Val path')
    parser.add_argument('--test', type=str, default=r'D:\Backup\桌面\当前工作\0_data_process\my_radar_sound\data\unseen\2mix\test', help='Test path')
    ...
    parser.add_argument('--mix_num', type=int, default=3, help='Mix num')
    ...
    #basic 
    parser.add_argument('--model_path', type=str, default='log/24-02-27-22-25-55/model/best_train.pth', help='Model path')
